...
import { Receipt, Plus, Check, X, IndianRupee, MapPin, Calendar, FileText, Trash2, Wallet, Clock, Loader2 } from 'lucide-react';
...
const BillSubmission = () => {
  ...
  const totalApprovedBills = bills.filter(b => b.status === 'approved').reduce((sum, b) => sum + b.approved_amount, 0);
      ...
      <Dialog open={approveDialog.open} onOpenChange={(open) => setApproveDialog({ open, bill: null })}>
        <DialogContent className="max-w-sm">
          ...
          <DialogFooter>
            ...
            <Button className="bg-green-500 hover:bg-green-600" onClick={handleApproveBill}>
              Confirm Approval
            </Button>
          </DialogFooter>
        </DialogContent>
