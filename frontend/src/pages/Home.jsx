...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Our Team / Leadership */}
      <section id="team" className="py-16 px-4 bg-gradient-to-br from-slate-100 to-blue-50">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="space-y-12">
            {teamMembers.map((member, index) => (
              <div key={index} className="grid md:grid-cols-5 gap-8 items-start">
                ...
                <div className="md:col-span-2">
                  <div className="relative group">
                    ...
                    <div className="relative overflow-hidden rounded-2xl shadow-2xl transform transition-all duration-500 hover:scale-105 hover:rotate-1">
                      ...
                      <div className="absolute -bottom-1 -right-1 w-full h-full bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl -z-10 transform translate-x-2 translate-y-2"></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="md:col-span-3 space-y-4">
                  {/* Name & Designation */}
                  <div>
                    <h4 className="text-3xl font-black text-slate-900 mb-1 leading-tight">{member.name}</h4>
                    <p className="text-xl font-semibold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">{member.role}</p>
                    <div className="w-20 h-1 bg-gradient-to-r from-blue-600 to-blue-400 mt-2 rounded-full"></div>
                  </div>
                  
                  {/* Experience Description */}
                  <div>
                    <p className="text-base text-slate-700 leading-relaxed">{member.experience}</p>
                  </div>
                  
                  {/* Skills with 3D Effects */}
                  <div>
                    <h5 className="text-lg font-bold text-slate-900 mb-3 flex items-center">
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      {member.expertise.map((skill, idx) => (
                        <div 
                          key={idx} 
                          className="skill-badge-3d bg-gradient-to-br from-blue-600 to-blue-700 text-white px-4 py-2.5 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 transition-all cursor-default relative overflow-hidden group"
                        >
