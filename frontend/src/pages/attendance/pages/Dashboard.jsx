...
import { attendanceAPI, leaveAPI, holidayAPI, usersAPI, billAPI, advanceAPI } from '../services/api';
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="bg-blue-50 rounded-lg p-3 text-xs text-blue-800">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>Punch 9:45 - 10:15 AM → <span className="text-green-600 font-medium">Full Day</span> (recorded as 9:45)</li>
                <li>Punch 10:16 AM - 12:45 PM → <span className="text-yellow-600 font-medium">Half Day</span></li>
                <li>Punch after 12:45 PM → <span className="text-red-600 font-medium">Absent</span></li>
              </ul>
            </div>
          </div>
          <DialogFooter>
